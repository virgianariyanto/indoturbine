...
import { User, Mail, Lock, ArrowRight, ShieldCheck, Sparkles, Home } from "lucide-react";
...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    setLoading(true); // Keep loading until redirect or response
    if (error) {
      setLoading(false);
  ...
  return (
    <div className="min-h-screen w-full flex bg-slate-900 font-sans selection:bg-blue-500 selection:text-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-end p-16 justify-start">
        ...
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-blue-500/20 rounded-full blur-3xl pointer-events-none animate-pulse" />
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-red-500/10 rounded-full blur-3xl pointer-events-none animate-pulse" />
        ...
        <div className="relative z-20 max-w-xl text-white space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-xs font-semibold uppercase tracking-wider text-blue-300">
            <Sparkles className="w-4 h-4 text-blue-400" /> Enterprise Membership
          </div>
          <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight leading-tight">
            Elevate Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-300">Industrial Standards</span>.
          </h2>
          <p className="text-slate-300 text-base md:text-lg font-normal leading-relaxed max-w-md">
            Join Indoturbine to get direct access to premium procurement, expert engineering teams, and real-time turbine analytics.
          </p>
          ...
          <div className="pt-6 border-t border-white/10 flex items-center gap-6 text-sm text-slate-400">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-200 font-medium">SSL Encrypted</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-4 text-center sm:text-left">
            ...
            <p className="text-slate-500 text-sm sm:text-base font-normal">
              Register your professional details to get started with Indoturbine.
            </p>
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  type="text"
                  value={name}
                  placeholder="Ir. Wirjawan Subianto"
            ...
            >
              {loading ? (
                <div className="flex items-center justify-center gap-2.5">
                  ...
                  <span className="text-sm font-bold">Creating Account...</span>
                </div>
              ) : (
                <>
