...
export default function DashboardWrapper({ children, user }) {
  ...
  const navItems = [
    ...
    { name: "Turbine Fleet", href: "/dashboard/fleet", icon: Cpu },
    { name: "Analytics & Telemetry", href: "/dashboard/analytics", icon: TrendingUp },
    { name: "QHSE Reports", href: "/dashboard/qhse", icon: ShieldAlert },
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex font-sans selection:bg-blue-500 selection:text-white">
      ...
      {/* Sidebar */}
      <aside 
        className={`fixed inset-y-0 left-0 z-50 w-72 bg-white border-r border-slate-200 flex flex-col transform transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 ${
