  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto space-y-6 sm:space-y-8">
        ...
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 backdrop-blur-md border border-white/10 text-[10px] sm:text-xs font-semibold uppercase tracking-widest text-blue-300 mb-2">
          <Sparkles className="w-3.5 h-3.5 text-blue-400" />
          <span>Integrated Turbine Services & Telemetry</span>
        </div>
        ...
        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-zinc-300 max-w-3xl mx-auto leading-relaxed font-normal">
          Empowering energy and manufacturing sectors with state-of-the-art gas turbine maintenance, 
          precision engineering solutions, and high-performance real-time telemetry.
        </p>
